const translations = {
    ...
    zh: {
        ...
        ugiScore: "UGI 分数",
        ugiRange: "范围：0-100",
        ugiDescription: "衡量模型在无审查主题上的<strong>知识广度</strong>。分数越高表示理解和处理多样化、潜在敏感信息的能力越强。",
        w10Score: "W/10 分数",
        w10Range: "范围：0-10",
        ...
        footerNote: "UGI衡量模型对无审查信息的了解 | W/10衡量回答意愿（0-10）",
        
        // Tooltips
        ugiTooltip: "无审查通用智能：敏感话题的知识广度（0-100）",
    ...
    ar: {
        ...
        subtitle: "تتبع الذكاء العام غير المراقب في نماذج الذكاء الاصطناعي",
        liveIndicator: "مباشر",
        ...
        ugiDescription: "يقيس <strong>اتساع المعرفة</strong> للنموذج في المواضيع غير المراقبة. تشير النقاط الأعلى إلى قدرة أكبر على فهم ومعالجة المعلومات المتنوعة والحساسة المحتملة.",
        w10Score: "نقاط W/10",
        ...
        footerNote: "UGI يقيس معرفة النموذج بالمعلومات غير المراقبة | W/10 يقيس الاستعداد للإجابة (0-10)",
        
        // Tooltips
        ugiTooltip: "الذكاء العام غير المراقب: اتساع المعرفة في المواضيع الحساسة (0-100)",
